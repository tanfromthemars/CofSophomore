                ...
                for (int i = hx.Length - 1; i < hx.Length && i >= 0; i--)
                {
                    if (hx[i] >= 10)
                    {
                        switch (hx[i])
                        {
                            ...
                            case 11: { Console.WriteLine("B"); break; }
                            case 12: { Console.WriteLine("C"); break; }
                            case 13: { Console.WriteLine("D"); break; }
                            case 14: { Console.WriteLine("E"); break; }
                            case 15: { Console.WriteLine("F"); break; }
                        }
                    }
